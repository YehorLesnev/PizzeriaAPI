...
import {title as titl} from "@/components/primitives";
...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="min-h-[210vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 mb-48 pb-20"
        >
            <motion.h2
                style={{
            ...
            >
                {title || (
                    <span>
                        <h1 className={titl()}>Now you can buy pizza just from your laptop</h1> <br /> No kidding.
          </span>
                )}
            </motion.h2>
            {/* Lid */}
