...
namespace Pizzeria.Domain.Migrations
{
    ...
    [Migration("20240420202646_AddGetSalesDistributionByCategoryAndDayProcedure")]
    partial class AddGetSalesDistributionByCategoryAndDayProcedure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Address", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("City"), new[] { "AddressId", "Address1", "Address2", "Zipcode" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Customer", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("FirstName", "LastName"), new[] { "Id", "PhoneNumber" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Ingredient", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IngredientName"), new[] { "IngredientId", "IngredientPrice", "IngredientWeightMeasure", "QuantityInStock" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Item", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ItemCategory"), new[] { "ItemId", "ItemName", "ItemSize", "ItemPrice", "ImagePath" });

                    b.HasIndex("ItemName");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ItemName"), new[] { "ItemId", "ItemCategory", "ItemSize", "ItemPrice", "ImagePath" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Order", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CustomerId"), new[] { "OrderId", "Date", "StaffId" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Recipe", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("RecipeName"), new[] { "RecipeId", "CookingTime" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Shift", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ShiftDate"), new[] { "ShiftId", "ShiftStartTime", "ShiftEndTime" });
            ...
            modelBuilder.Entity("Pizzeria.Domain.Models.Staff", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("FirstName", "LastName"), new[] { "StaffId", "Position", "HourlyRate" });
