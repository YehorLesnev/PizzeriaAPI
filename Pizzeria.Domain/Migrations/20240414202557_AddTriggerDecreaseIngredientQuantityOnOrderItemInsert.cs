...
{
    /// <inheritdoc />
    public partial class AddTriggerDecreaseIngredientQuantityOnOrderItemInsert : Migration
    {
        /// <inheritdoc />
        ...
        -- SQL script for creating the trigger
        CREATE TRIGGER [dbo].[DecreaseIngredientQuantityOnOrderItemInsert]
        ON [dbo].[order_items]
        AFTER INSERT
        AS
        BEGIN
    ...
    ");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
        -- SQL script for dropping the trigger
        IF OBJECT_ID('dbo.DecreaseIngredientQuantityOnOrderItemInsert', 'TR') IS NOT NULL
        BEGIN
